   ...
   public class BoxBuilder : _3DModel
    {
        ...
        public override HelixToolkit.SharpDX.Core.MeshGeometry3D DrawModel()
        {
            ...
            //res.Add(allTriVertex[0]); res.Add(allTriVertex[2]); res.Add(allTriVertex[1]);
            //res.Add(allTriVertex[1]); res.Add(allTriVertex[2]); res.Add(allTriVertex[3]);
            //res.Add(allTriVertex[0]); res.Add(allTriVertex[4]); res.Add(allTriVertex[2]);
            //res.Add(allTriVertex[2]); res.Add(allTriVertex[4]); res.Add(allTriVertex[6]);
            //res.Add(allTriVertex[0]); res.Add(allTriVertex[1]); res.Add(allTriVertex[4]);
            //res.Add(allTriVertex[1]); res.Add(allTriVertex[5]); res.Add(allTriVertex[4]);
            //res.Add(allTriVertex[1]); res.Add(allTriVertex[7]); res.Add(allTriVertex[5]);
            //res.Add(allTriVertex[1]); res.Add(allTriVertex[3]); res.Add(allTriVertex[7]);
            //res.Add(allTriVertex[4]); res.Add(allTriVertex[5]); res.Add(allTriVertex[6]);
            //res.Add(allTriVertex[7]); res.Add(allTriVertex[6]); res.Add(allTriVertex[5]);
            //res.Add(allTriVertex[2]); res.Add(allTriVertex[6]); res.Add(allTriVertex[3]);
            //res.Add(allTriVertex[3]); res.Add(allTriVertex[6]); res.Add(allTriVertex[7]);
            //List<Vector3> normal = new List<Vector3>();
            //normal.Add(norm);
            //builder.AddTriangles(res);
